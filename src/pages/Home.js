  ...
  return (
    <div className='flex flex-col justify-between h-5/6 w-full py-6 px-10'>
      ...
      <div className='flex flex-col space-y-6 mt-8'>
        ...
        <div>
          <h1 className='font-bold text-4xl w-2/5'>
            {title}
          </h1>
        ...
        <div className='w-full flex flex-row space-x-6'>
          ...
          >
            ...
            >
              ...
              <div
                className='group transition-all ease-in duration-200 w-12 h-12 p-2 rounded-full hover:bg-white hover:text-gray-900 hover:shadow-lg'
              >
